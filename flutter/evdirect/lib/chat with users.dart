...
class MyChatApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyChatUser(title: 'Flutter Demo Home Page'),
    );
  }
}

class MyChatUser extends StatefulWidget {
  const MyChatUser({super.key, required this.title});
  ...
  @override
  State<MyChatUser> createState() => _MyChatUserState();
}
...
class _MyChatUserState extends State<MyChatUser> {
  int _counter = 0;
  String name = "";
  ...
  Future<void> view_message() async {
    ...
    try {
      ...
      String url = '$urls/and_userviewchat/';

      var data = await http.post(Uri.parse(url), body: {
        'from_id': pref.getString("lid").toString(),
        'to_id': pref.getString("wid").toString()
