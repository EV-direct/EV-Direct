                  ...
                  Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        FadeInUp(duration: Duration(milliseconds: 2000), child: TextButton(onPressed: (){
                          Navigator.push(context, MaterialPageRoute(
                            builder: (context) => WorkerSignupPage(title: "Login"),));
                        },child: Text("Worker Signup", style: TextStyle(color: Color.fromRGBO(143, 148, 251, 1)),))),
                        FadeInUp(duration: Duration(milliseconds: 2000), child: TextButton(onPressed: (){

                          Navigator.push(context, MaterialPageRoute(
                            builder: (context) => UserSignupPage(title: "Login"),));
                        },child: Text("User Signup", style: TextStyle(color: Color.fromRGBO(143, 148, 251, 1)),))),
                        // FadeInUp(duration: Duration(milliseconds: 2000), child: TextButton(onPressed: (){
                        //
                        //
                        // },
