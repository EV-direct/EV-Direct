...
class Usersignup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const UserSignupPage(title: 'Flutter Demo Home Page'),
    );
  }
}
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("Register as User", style: TextStyle(color: Colors.white),),
        ),
        body: Center(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  // Use TextFormField with email validation
                  // Container(
                  //   padding: const EdgeInsets.all(10),
                  //   child: TextFormField(
                  //     controller: emailcontroller,
                  //     validator: validateEmail, // Call the validateEmail function
                  //     decoration: const InputDecoration(
                  //       border: OutlineInputBorder(),
                  //       labelText: 'Email',
                  //     ),
...
void _send_data() async{
  ...
  final urls = Uri.parse('$url/usr_signup/');
  try {
